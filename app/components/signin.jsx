  ...
  return (
    <div className="flex flex-col">
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-3 rounded-lg border border-[#1e2050] bg-[#0d0d1a] px-3.5 py-2.5 text-sm font-medium text-white transition hover:bg-white/5 mb-4"
      >
